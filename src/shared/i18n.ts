...
export interface Strings {
  ...
  filterAll: string         // 전체 모드 세그먼트
  filterAllow: string       // 허용 모드 세그먼트
  filterBlock: string       // 차단 모드 세그먼트
  filterAllDesc: string     // 전체 모드 설명(모든 창)
...
const en: Strings = {
  ...
  filterAllow: 'Allow',
  filterBlock: 'Block',
  filterAllDesc: 'Works on all windows',
...
const hi: Strings = {
  ...
  filterAllow: 'अनुमति',
  filterBlock: 'ब्लॉक',
  filterAllDesc: 'सभी विंडो पर काम',
...
const es: Strings = {
  ...
  filterAll: 'Todas',
  filterAllow: 'Permitir',
  filterBlock: 'Bloquear',
  filterAllDesc: 'Funciona en todas',
